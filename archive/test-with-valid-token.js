...
// Use a valid token from the direct auth test
const validToken = 'efa131aa-3488-476b-9cab-f6e567d0753e';
...
function testSendMessage() {
    const messageData = JSON.stringify({
        ...
        content: 'Test message with valid token - ' + new Date().toISOString()
    });
